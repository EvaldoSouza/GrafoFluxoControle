        ...
        try {
            ...
            while(scan.hasNextLine()){
                ...
                if(!valfa.getProxEDestinoGOTO() && scan.hasNextLine()){
                    //se for destino de goto, teho q manter a linha, se n for, posso pegar a proxima linha
                    linha = scan.nextLine();
                ...
                if(!scan.hasNextLine() && valfa.getSaida() != null && !valfa.getSaida().getLinha().equals(linha) ){//acabou o arquivo
